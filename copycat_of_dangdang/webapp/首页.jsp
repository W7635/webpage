...
<div class="top-bar">
    ...
    <label class="label_denglu">欢迎光临当当，请<a href="登录.jsp" class="a_denglu">登录</a>成为会员</label>
    <a href="登录.jsp" class="a_gouwuche">|购物车</a>
    <a href="登录.jsp" class="a_wodedingdan">|我的订单</a>
</div>
...
<div class="pagination-container">
    <div class="page" id="page1">
        <div class="row">
            <div class="item">
                <a href="登录.jsp" style="text-decoration: none;color: black">
